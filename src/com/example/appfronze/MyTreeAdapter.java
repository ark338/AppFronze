...
public class MyTreeAdapter extends BaseAdapter {
	...
	private TreeSet<AppInfo> mAppTree;
	private MyTreeAdapter mAdapter;

	public MyTreeAdapter(Context context, TreeSet<AppInfo> appTree) {
		this.mAdapter = this;
		this.mContext = context;
		this.mInflater = LayoutInflater.from(context);
		this.mAppTree = appTree;
	}
	
	@Override
	public int getCount() {
		return mAppTree.size();
	}

	@Override
	public Object getItem(int position) {
		// FIXME
//		return mAppTree.get(position);
		return null;
	}
